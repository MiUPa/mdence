      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
            Install MDence from the VS Code Marketplace or search for it directly in your editor.
          </p>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-3xl">
          <div className="grid gap-8 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-slate-800">
              ...
              <div className="mt-6">
                <p className="mb-3 text-sm text-slate-600 dark:text-slate-400">
                  Search in Extensions with the same identifier:
                </p>
                <code className="block rounded-lg bg-slate-100 px-4 py-3 text-sm text-slate-800 dark:bg-slate-900 dark:text-slate-200">
                  miupa.mdence
                </code>
